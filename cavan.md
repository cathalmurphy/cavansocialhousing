...
## **Chapter 1: Background and context** <a name="chapter-1--background-and-context"></a>
### 1.1: Project Outline <a name="11--project-outline"></a>
...
### 1.2: Why ghost estates? <a name="12--why-ghost-estates-"></a>
...
### 1.3: Typically-associated datasets <a name="13--typically-associated-datasets"></a>
...
## **Chapter 2: Spatial data and criteria specification** <a name="chapter-2--spatial-data-and-criteria-specification"></a>
### 2.1: Data sources <a name="21--data-sources"></a>
...
### 2.2: Projection problems <a name="22--projection-problems"></a>
...
### 2.3: Creating spatial datasets for Cavan <a name="23--creating-spatial-datasets-for-cavan"></a>
...
## **Chapter 3: Modelling criteria** <a name="chapter-3--modelling-criteria"></a>
### 3.1: Modelling factors and constraints <a name="31--modelling-factors-and-constraints"></a>
...
***Table 1: List of criteria by type and weight*** <a name="table1"></a>

### 3.2: Factor: Distance to towns <a name="32--factor--distance-to-towns"></a>
...
***Figure 1: Maps for distance to towns and villages*** <a name="figure1"></a>


### 3.3: Factor - Distance to lakes <a name="33--factor---distance-to-lakes"></a>
...
***Figure 2: Maps for distance to lakes*** <a name="figure2"></a>

### 3.4: Factor - Distance to sports and leisure facilities <a name="34--factor---distance-to-sports-and-leisure-facilities"></a>
...
***Figure 3: Maps for distance to sports and leisure facilities*** <a name="figure3"></a>


### 3.5: Factor - Distance to major roads <a name="35--factor---distance-to-major-roads"></a>
...
***Figure 4: Maps for distance to major roads*** <a name="figure4"></a>


### 3.6: Factor - distance from mineral extraction sites <a name="36--factor---distance-from-mineral-extraction-sites"></a>
...
***Figure 5: Maps for distance to mineral extraction sites*** <a name="figure5"></a>


### 3.7: Constraint - Protected heritage areas <a name="37--constraint---protected-heritage-areas"></a>
...
### 3.8: Constraint - Bogs and marshes <a name="#38--constraint---bogs-and-marshes"></a>
...
### 3.9: Constraints - Slopes <a name="39--constraints---slopes"></a>
...
***Table 2: Degree of slope and development potential (Lehigh Valley Planning Commission, 2008)*** <a name="table2"></a>
...
## **Chapter 4: Final suitability raster** <a name="chapter-4--final-suitability-raster"></a>
### 4.1: Weighing criteria <a name="41--weighing-criteria"></a>
...
### 4.2: Final suitability raster <a name="42--final-suitability-raster"></a>
...
***Figure 6: Final MCE Suitability Index with unfinished estates point file overlain*** <a name="figure6"></a>


### 4.3: Summary of results <a name="43--summary-of-results"></a>
...
0.5101 – 0.5483|28
0.5483 – 0.6079|50
***Table 3: Distribution of unfinished estates by suitability score band*** <a name="table3"></a>
...
### 4.4: Potential impacts <a name="44--potential-impacts"></a>
...
## **Chapter 5: Conclusion** <a name="chapter-5--conclusion"></a>
### 5.1: Possible improvements and technical difficulties <a name="51--possible-improvements-and-technical-difficulties"></a>
...
### 5.2: Concluding remarks <a name="52--concluding-remarks"></a>
...
## **Bibliography** <a name="bilbiography"></a>
